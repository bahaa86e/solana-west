      ...
      <Container as="div" size="wide" className="grid grid-cols-1 gap-0 lg:grid-cols-12 lg:items-stretch xl:gap-x-4">
        ...
        >
          <div className="max-w-lg xl:max-w-xl">
            <p className="font-sans uppercase text-micro tracking-[0.18em] text-lux-ink/38">{hero.eyebrow}</p>
            ...
            <p
              className={cn(
                "mt-8 max-w-[22rem] border-l border-lux-ink/[0.1] pl-5 leading-[1.72] md:mt-9 md:max-w-[28rem]",
                proseBody,
                "text-lux-ink/52 xl:max-w-2xl",
              )}
            >
              {hero.supporting}
            </p>
        ...
        >
          <LuxuryFillImage
            ...
            priority
            quality={88}
            imgClassName="object-cover object-[center_44%]"
          />
