      ...
      <Container as="div" size="wide" className="grid grid-cols-1 gap-0 lg:grid-cols-12 lg:items-stretch xl:gap-x-4">
        ...
        >
          <div className="max-w-lg xl:max-w-xl">
            ...
            <p
              className={cn(
                "mt-[clamp(2rem,4.5vw,2.75rem)] max-w-[24rem] leading-[1.76] md:max-w-md xl:max-w-lg",
            ...
            <p
              className={cn(
                "mt-8 max-w-[22rem] border-l border-lux-gold/28 pl-5 leading-[1.72] md:mt-9 md:max-w-[28rem]",
                proseBody,
                "text-lux-ink/52",
              )}
            >
        ...
        >
          <LuxuryFillImage
            ...
            priority
            quality={88}
            imgClassName="object-cover object-[center_40%]"
          />
