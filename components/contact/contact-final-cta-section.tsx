    ...
    >
      <div className="flex flex-col gap-14 lg:flex-row lg:items-center lg:justify-between lg:gap-20 xl:gap-28">
        <div className="max-w-xl xl:max-w-2xl">
          <SectionHeader id={headingId} eyebrow={finalCta.eyebrow} tone="onDark" title={finalCta.title} />
        ...
        <div className="flex w-full max-w-lg flex-col gap-4 md:flex-row md:gap-5">
          <CtaButton
            ...
            data-track-placement="contact_footer_whatsapp"
          >
          ...
          <CtaButton
            ...
            data-track-placement="contact_footer_prices"
          >
