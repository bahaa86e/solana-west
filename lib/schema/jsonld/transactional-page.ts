...
/**
 * WebPage + FAQ preview + breadcrumbs for transactional pages (pricing, payment-plan).
 * FAQ answers must match visible `<dt>/<dd>` rendering (canonical subset).
 */
export function getTransactionalStructuredData(seo: RouteSeoDefinition, model: TransactionalPageModel) {
