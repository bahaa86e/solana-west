  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 120% 90% at 50% 118%, rgba(18, 14, 12, 0.11) 0%, rgba(18, 14, 12, 0.04) 42%, transparent 62%)",
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(10,10,10,0.022) 1px, transparent 1px),
      ...
      <div
        className="absolute inset-0 shadow-[inset_0_0_100px_36px_rgba(8,6,5,0.055),inset_0_-72px_90px_rgba(8,6,5,0.038)]"
      />
    </div>
  );
}
