...
/**
 * High transactional intent — apartments / vertical SKUs + bracket literacy.
 */
...
export const solanaWestApartmentsPricesBuyerGuideNewZayed2026Article: BlogArticleDocument = {
  ...
  internalLinks: {
    ...
    links: [
      ...
      {
        label: "Villas prices buyer guide",
        href: "/blog/solana-west-villas-prices-buyer-guide-new-zayed-2026",
        context: "Land-led bracket contrast.",
      },
      {
        label: "Payment plan explained",
        href: "/blog/solana-west-payment-plan-explained-issuer-guide-2026",
        context: "Curve literacy.",
      },
      {
        label: "Location guide Mehwar",
        href: "/blog/solana-west-mehwar-new-zayed-location-buyer-guide-2026",
        context: "Commute realism.",
      },
      { label: "Contact", href: "/contact", context: "Apartment enquiry." },
    ],
  },
